...
def get_dv(start = 20170101,end = 20180101): 
    ...
    #define
    factor_list = ['turnover_ratio','volume','tot_non_cur_liab','tot_liab_shrhldr_eqy',
    'less_selling_dist_exp','total_oper_rev','undistributed_profit','capital_stk']
...
from Tamplatess import cap,macdmax,tur_close
alpha = ['cap','macdmax','tur_close']
for f in alpha:
