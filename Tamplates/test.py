...
def get_dv(start = 20170101,end = 20180101): 
    ...
    #define
    factor_list  = ['volume', 'pb', 'roe','turnover_ratio','BBI','EPS','PE','PS','ACCA','CTOP','MA10RegressCoeff12','AR','BR','ARBR','np_parent_comp_ttm','total_share','bps']
...
from Tamplate import alpha189,alpha150,alpha101_003,alpha101_012,alpha101_013,alpha101_015,alpha101_016,alpha101_018,alpha101_026,alpha101_040,alpha101_044
alpha = ['alpha189','alpha150','alpha101_003','alpha101_012','alpha101_013','alpha101_015','alpha101_016','alpha101_018','alpha101_026','alpha101_040','alpha101_044']
for f in alpha:
